 ...
 * http://github.com/CaliStyle/humpbck-core-pack
 */
angular.module('humpbackSails.io', [])
 ...
 */
    ...
    .provider('$sailsSocket', function () {
        ...
        var SailsSocketFactory = function ($q, $timeout, SocketIo, $$sailsSDKInfo) {
            ...
            /**
             * @ngDoc function
             * @name humpbackSails.io.SailsResponse
             *
             * @description
             *
            ...
            /**
             * @ngDoc function
             * @name humpbackSails.io.SailsSocket
             *
             * @param options
             * @constructor
             */
            ...
            function sendReq(config, reqData, reqHeaders) {
                ...
                function resolvePromise(response, status, headers, statusText) {
                    ...
                    (isSuccess(status) ? deferred.resolve : deferred.reject)({
                        ...
                        contentCount: contentGetter(headers)
                    });
                }
...
angular.module('humpback.io', []).provider('$sailsSocket',$sailsSocketProvider).provider('$sailsSocketBackend',sailsBackendProvider);
...
function createSailsBackend($browser, $window, $injector, $q, $timeout){
    ...
    function connection(method, url, post, callback, headers, timeout, withCredentials, responseType){
        ...
        function socketResponse(body, jwr){
            ...
            callback(jwr.statusCode, body, jwr.headers, jwr.error || "OK");
...
function contentGetter(headers){
    var headersObj = isObject(headers) ? headers : undefined, contentCount;
    if (!headersObj) headersObj =  parseHeaders(headers);

    if(headersObj['content-count']){
        contentCount = headersObj['content-count'];
    }
